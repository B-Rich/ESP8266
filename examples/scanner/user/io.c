...
#define TESTLED          2        // Use GPIO 2 for the TEST LED if single UART

static ETSTimer resetBtntimer;    // Timer object

// ----------------------------------------------------------------------------
// Turn Test LED On or off.
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// kbhit()
// Detects if a key was pressed on the RS232 line
// ----------------------------------------------------------------------------
bool kbhit(void)
{
...
// ----------------------------------------------------------------------------
// getch()
// Gets a character from the RS232 comm port.
// ----------------------------------------------------------------------------
char getch(void)
{
...
// ----------------------------------------------------------------------------
// Send one character to Comm Port 0, all os_printf output is re-directed
// to this port. Also, the carriage return is tacked on so you don't have to
// always include that.
// ----------------------------------------------------------------------------
...
// Sets up the Port 0 RS232 pins and sets the baud rate, stop bits and etc.
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// IO Initialization:
// Set up the GPIO pins and install the timer to check the input button.
// ----------------------------------------------------------------------------
void ioInit(void)
{
    stdoutInit();
