...
#define MOTGPIO          5   // Use GPIO 5 for the Motor
...
{
    if(ena) GPIO_OUTPUT_SET(MOTGPIO, 1);
    else    GPIO_OUTPUT_SET(MOTGPIO, 0);
}
...
void ioInit(void)
{
    ...
    gpio_output_set(0, 0, (1 << MOTGPIO), 0);                // Set BUSYLED GPIO to output
