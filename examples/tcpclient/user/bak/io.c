...
// ----------------------------------------------------------------------------
#define BTNGPIO    0        // Use GPIO0 for input button
...
{
    GPIO_OUTPUT_SET(MUXGPIO0, (bool)((mux   ) & 0x01));    
    GPIO_OUTPUT_SET(MUXGPIO1, (bool)((mux>>1) & 0x01));    
    GPIO_OUTPUT_SET(MUXGPIO2, (bool)((mux>>2) & 0x01));    
    GPIO_OUTPUT_SET(MUXGPIO3, (bool)((mux>>3) & 0x01)); 
//  os_delay_us(10000);    
}
...
static void ICACHE_FLASH_ATTR resetBtnTimerCb(void *arg)
{
    ...
    if(!GPIO_INPUT_GET(BTNGPIO)) {          // if button is low, then count
        resetCnt++;
    }
